...
A docsify plugin is a function with the ability to execute custom JavaScript code at various stages of PGPJS's lifecycle.

## Setup

PGPJS plugins can be added directly to the `plugins` array:
...
- Access PGPJS methods and properties using `window.PGPJS`
- Access the current PGPJS instance using the `vm` argument
    ...
    function pageFooter(hook, vm) {
      const footer = /* html */ `
        ...
        <footer>
          ...
          <span>Proudly published with <a href="https://github.com/pgpjs/docs" target="_blank">docsify</a>.</span>
        </footer>
      `;
