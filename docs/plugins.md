...
These are built-in and external plugins for PGPJS.
...
<script src="/dist/pgpjs.min.js"></script>
<script src="/dist/plugins/ga.min.js"></script>
```
...
<!-- prettier-ignore -->
```html
<script src="/dist/pgpjs.min.js" data-ga="UA-XXXXX-Y"></script>
<script src="/dist/plugins/ga.min.js"></script>
```
...
<script src="/dist/pgpjs.min.js"></script>
<script src="/dist/plugins/gtag.min.js"></script>
```

## Emoji

Renders a larger collection of emoji shorthand codes. Without this plugin, PGPJS is able to render only a limited number of emoji shorthand codes.

> [!IMPORTANT] Deprecated as of v4.13. PGPJS no longer requires this plugin for full emoji support.
...
```html
<script src="/dist/plugins/external-script.min.js"></script>
```
...
<script src="/dist/plugins/disqus.min.js"></script>
```
...
<script src="/dist/plugins/gitalk.min.js"></script>
...
A pgpjs.js plugin for displaying tabbed content from markdown.
