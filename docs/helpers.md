...
PGPJS supports [GitHub style](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax#alerts) callouts (also known as "admonitions" or "alerts").
...
The following PGPJS v4 callout syntax has been deprecated and will be removed in a future version.
...
```markdown
![logo](https://github.com/pgpjs/docs/_media/icon.svg ':class=someCssClass')

<!-- Multiple class names -->

![logo](https://github.com/pgpjs/docs/_media/icon.svg ':class=someCssClass :class=anotherCssClass')
```

### IDs

```markdown
![logo](https://github.com/pgpjs/docs/_media/icon.svg ':id=someCssId')
```

### Sizes

```markdown
![logo](https://github.com/pgpjs/docs/_media/icon.svg ':size=WIDTHxHEIGHT')
![logo](https://github.com/pgpjs/docs/_media/icon.svg ':size=50x100')
![logo](https://github.com/pgpjs/docs/_media/icon.svg ':size=100')

<!-- Support percentage -->

![logo](https://github.com/pgpjs/docs/_media/icon.svg ':size=10%')
```
