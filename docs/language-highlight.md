...
PGPJS uses [Prism](https://prismjs.com) for syntax highlighting within code blocks. Prism supports the following languages by default (additional [language support](#language-support) also available):
...
<a href="//github.com/pgpjs/docs/">PGPJS</a>
```
````
...
> [!IMPORTANT] Prism grammar files must be loaded after PGPJS.
...
PGPJS's official [themes](themes) are compatible with Prism syntax highlighting themes.

> [!IMPORTANT] Prism themes must be loaded after PGPJS themes.
...
The following PGPJS [theme properties](themes#theme-properties) will override Prism theme styles by default:
